...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=ynamadi&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=ynamadi&repo=tanzu-java-web-app'
